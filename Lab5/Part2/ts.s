...
reset_handler:
  ...
  /* go back in SVC mode */
  MSR cpsr, #0xD3      // write to cspr, so in SVC mode now
...
// enable MMU
  ...
  mcr p15, 0, r0, c1, c0, 0   // write r0 to MMU c1 register
  nop
  nop
  nop
...
//  adr r0, mainstart        // adr instruction is tricky
...
// now in SYS mode, r13 same as User mode sp r14=user mode lr
   ...
   //mrs r4, cpsr       // r4 = user mode cpsr
   //str r4, [r6, #16]  // save Umode cpsr into PROC.cpse at offset 16
...
//   ldr r4, [r5, #16]  // restore Umode cpsr from PROC.cpsr
//   mrs r4, cpsr
